...
Operational brief for any AI agent working on the `joeblew999` branch of `d1-manager`.
...
Cloudflare D1 admin UI fork. Provision via cf:provision-d1-r2 + cf:access-setup; deploy via 10-deploy; verify via prove:all.
